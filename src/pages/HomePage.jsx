...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-4 max-w-sm rounded-2xl border border-[#f4c96b] bg-[#f8d8aa] p-8 mt-10 shadow-sm">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold text-[#f2a451]">Huddle</h1>
        <h2 className="text-sm font-medium text-[#7d8794]">
          Find your people, no fee required
        </h2>
        <p className="text-sm leading-relaxed text-[#29272b]">
