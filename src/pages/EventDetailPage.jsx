...
export default function EventDetailPage() {
  ...
  if (!event) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
        ...
        <p className="text-gray-500 mb-4">We couldn't find the details for this event.</p>
  ...
  const progressPercentage = Math.round((event.attendeeCount / event.attendeeGoal) * 100);
  ...
  return (
    ...
    // The main container for the entire page that takes up the full screen height
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="px-5 pt-6 pb-8 space-y-8 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Price</p>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
          <h2 className="text-xl font-bold text-purple-700 mb-3">About this Event</h2>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-end mb-3">
            ...
            <div className="text-right">
              <span className="text-xl font-bold text-gray-900">👥 {event.attendeeCount}</span>
          ...
          <p className="text-sm text-gray-600 font-medium">{progressPercentage}% of goal reached</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <p className="font-medium text-gray-900 max-w-50 truncate" title={event.address}>
                {event.address}
              </p>
            </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 pb-8 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <div className="max-w-2xl mx-auto">
          <button className="w-full bg-green-100 text-green-800 font-bold py-4 rounded-xl flex flex-col items-center justify-center transition-colors hover:bg-green-200">
            <span className="flex items-center gap-2 text-lg">✅ You're Going!</span>
            <span className="text-sm font-medium text-green-700">RSVP confirmed — see you there</span>
          </button>
        </div>
      </div>
